...
export interface DriverSpec {
  ...
  // ⚑ REQUIRED SINCE 2026-09-11 (lib/vehicle-rules.ts). Fixture values: a plausible
  // VTC fleet, every car inside the seven-year limit unless its energy exempts it.
  energy: string; firstRegistered: string;
...
export const DRIVERS: DriverSpec[] = [
  { first: "Marc",     last: "Fontaine",  email: "marc.fontaine@kavenue.test",  category: "business", body: "sedan", make: "Mercedes", model: "Classe E", colour: "noir", plate: "AB-123-CD", energy: "hybride_rechargeable", firstRegistered: "2022-04-11", seats: 4, base: "nice",    radius: 55, verified: true,  luggage: false, joinDay: 0,  languages: ["fr", "en"],       appetite: 0.9 },
  { first: "Sofia",    last: "Berger",    email: "sofia.berger@kavenue.test",   category: "business", body: "sedan", make: "BMW",      model: "Série 5",  colour: "gris",  plate: "CE-456-FG", energy: "hybride_rechargeable", firstRegistered: "2023-02-20", seats: 4, base: "lecannet",    radius: 45, verified: true,  luggage: false, joinDay: 0,  languages: ["fr", "en", "de"], appetite: 0.85 },
  { first: "Karim",    last: "Nasri",     email: "karim.nasri@kavenue.test",    category: "luxury",   body: "van",   make: "Mercedes", model: "Classe V", colour: "noir",  plate: "GH-789-IJ", energy: "diesel", firstRegistered: "2021-06-03", seats: 7, base: "juanlespins", radius: 60, verified: true,  luggage: true,  joinDay: 2,  languages: ["fr", "en", "ar"], appetite: 0.7 },
  { first: "Élodie",   last: "Marchand",  email: "elodie.marchand@kavenue.test",category: "eco",      body: "sedan", make: "Peugeot",  model: "508",      colour: "blanc", plate: "KL-012-MN", energy: "hybride", firstRegistered: "2022-09-15", seats: 4, base: "stlaurent",    radius: 35, verified: true,  luggage: false, joinDay: 5,  languages: ["fr"],             appetite: 0.95 },
  // ⚑ THOMAS IS BASED IN MONACO, SO HIS PLATE IS MONACO'S (2026-09-11). It was a French
  //   "OP-345-QR" — and under the founder's rule (a car's country is its Driver's
  //   country) his own plate would be refused and his car could never be finished.
  //   Monaco format per arrêté ministériel 78-5 art. 6: one letter + up to 3 digits.
  { first: "Thomas",   last: "Rey",       email: "thomas.rey@kavenue.test",     category: "luxury",   body: "sedan", make: "Mercedes", model: "Classe S", colour: "noir",  plate: "L482", energy: "hybride_rechargeable", firstRegistered: "2023-05-30", seats: 4, base: "monaco",   radius: 40, verified: true,  luggage: false, joinDay: 9,  languages: ["fr", "en", "it"], appetite: 0.6 },
  { first: "Nadia",    last: "Bouchard",  email: "nadia.bouchard@kavenue.test", category: "business", body: "van",   make: "Volkswagen", model: "Multivan", colour: "gris", plate: "ST-678-UV", energy: "diesel", firstRegistered: "2020-11-18", seats: 7, base: "mougins",    radius: 70, verified: true,  luggage: true,  joinDay: 14, languages: ["fr", "en"],       appetite: 0.8 },
  { first: "Julien",   last: "Astier",    email: "julien.astier@kavenue.test",  category: "eco",      body: "sedan", make: "Skoda",    model: "Superb",   colour: "gris",  plate: "WX-901-YZ", energy: "hybride_rechargeable", firstRegistered: "2021-03-09", seats: 4, base: "cannes",    radius: 30, verified: true,  luggage: false, joinDay: 21, languages: ["fr", "en"],       appetite: 0.75 },
  { first: "Inès",     last: "Lefranc",   email: "ines.lefranc@kavenue.test",   category: "business", body: "sedan", make: "Audi",     model: "A6",       colour: "bleu",  plate: "AA-234-BB", energy: "hybride_rechargeable", firstRegistered: "2022-07-22", seats: 4, base: "cagnes",    radius: 50, verified: true,  luggage: false, joinDay: 33, languages: ["fr", "en", "es"], appetite: 0.7 },
  { first: "Bastien",  last: "Roux",      email: "bastien.roux@kavenue.test",   category: "luxury",   body: "sedan", make: "Bentley",  model: "Flying Spur", colour: "noir", plate: "CC-567-DD", energy: "essence", firstRegistered: "2023-10-02", seats: 4, base: "beausoleil",   radius: 80, verified: true,  luggage: false, joinDay: 47, languages: ["fr", "en", "ru"], appetite: 0.45 },
  { first: "Amine",    last: "Belkacem",  email: "amine.belkacem@kavenue.test", category: "business", body: "sedan", make: "Mercedes", model: "Classe E", colour: "noir",  plate: "EE-890-FF", energy: "diesel", firstRegistered: "2021-01-14", seats: 4, base: "antibes", radius: 45, verified: false, luggage: true,  joinDay: 62, languages: ["fr", "en"],       appetite: 0.8 },
  { first: "Clara",    last: "Vidal",     email: "clara.vidal@kavenue.test",    category: "eco",      body: "sedan", make: "Renault",  model: "Talisman", colour: "gris",  plate: "GG-123-HH", energy: "diesel", firstRegistered: "2020-10-05", seats: 4, base: "vallauris",    radius: 25, verified: false, luggage: false, joinDay: 74, languages: ["fr"],             appetite: 0.85 },
];
