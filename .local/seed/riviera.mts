...
export const DRIVERS: DriverSpec[] = [
  ...
  { first: "Thomas",   last: "Rey",       email: "thomas.rey@kavenue.test",     category: "luxury",   body: "sedan", make: "Mercedes", model: "Classe S", colour: "noir",  plate: "OP-345-QR", energy: "hybride_rechargeable", firstRegistered: "2023-05-30", seats: 4, base: "monaco",   radius: 40, verified: true,  luggage: false, joinDay: 9,  languages: ["fr", "en", "it"], appetite: 0.6 },
